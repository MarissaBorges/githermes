...
:   These methods are called to implement the augmented arithmetic assignments
    ...
    [Why does a\_tuple[i] += [‘item’] raise an exception when the addition works?](../faq/programming.html#faq-augmented-assignment-tuple-error)), but this behavior is in fact
...
[`__getattribute__()`](#object.__getattribute__ "object.__getattribute__") method even of the object’s metaclass:
